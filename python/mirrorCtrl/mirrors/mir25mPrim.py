...
def _makeMirror():
    ...
    # note: Sept 2023 updated with Dan O's values after shutdown
    #  previous values: [10450., -1100., 6850., 19700., 8500., 8550.]
    #  previous values: ActMountOffset = numpy.array([8600., -150., 7800., 16050., 8500., 8550.])
    ActMountOffset = numpy.array([8600., -150., 7800., 34500., 10950., 10950.])
