KeysDictionary("mirror35tert", (1,0), *(
    Key("text",
        String(),
        help = "Text message",
    ),
...
#     Key("timeout", help = "The command timed out"),
    ...
    Key("desOrient",
        ...
        Float(help="x tilt", units="as"),
        Float(help="y tilt", units="as"),
        Float(help="x translation", units="um"),
        Float(help="y translation", units="um"),
        Float(help="z rotation", units="as"),
    ...
    Key("cmdMount",
        Float(units="steps", invalid="NaN") * 3,
    ...
    Key("orient",
        ...
        Float(help="x tilt", units="as", invalid="NaN"),
        Float(help="y tilt", units="as", invalid="NaN"),
        Float(help="x translation", units="um", invalid="NaN"),
        Float(help="y translation", units="um", invalid="NaN"),
        Float(help="z rotation", units="as", invalid="NaN"),
        help = "desired mirror orientation",
    ),
    Key("actMount",
        Float(units = "steps", invalid="NaN") * 3,
    ...
    Key("status",
        Bits('stopcode:8', 'statusword:24') * 3, # should we breakdown status word into individual bits?
