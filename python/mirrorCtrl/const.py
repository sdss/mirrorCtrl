...
def convOrient2UMArcsec(orientation):
    ...
    @return orientation, of same length as input orient, with units in um and arcsec, as a numpy array
    """
...
def convOrient2MMRad(orientation):
    ...
    @param[in] orientation  list/array type of 1 to 6 elements
    @return orientation, of same length as input orient, with units in mm and radians, as a numpy array
    """
    return numpy.asarray(orientation)*_ConvertOrient[:len(orientation)]
