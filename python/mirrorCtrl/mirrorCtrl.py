...
class MirrorCtrl(Actor):
    ...
    def __init__(self,
        ...
        #     # # then queue a status
        #     # userCmd = UserCmd()
        #     # userCmd.cmdVerb = 'specialStatus' # special status has same priority as move, so moves will queue behind.
        #     # userCmd._cmdStr = 'status (autogenerated by killFunc)'
        #     # self.cmdQueue.addCmd(userCmd, self.galil.cmdStatus)
